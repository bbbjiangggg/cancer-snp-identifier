        ...
        if 'RR' in subdir.name:
            for file in subdir.iterdir():
                if file.suffix in [".vcf", ".vcf.gz"]:
                    ...
                    # Assuming filename structure: *_mapped_{chromosome}.var.-final.vcf
                    pattern = rf'_mapped_{chromosome}\.var\.-final\.vcf(\.gz)?$'
...
def main():
    ...
    # Immediately display a message after pressing enter
