#number of wells
wells = input('\033[1;45m Enter the number of wells you wish to use: \033[0;0;0m ')
print('\n')

inwellvol = input('\033[1;45m Enter the intended volume (ml) for each well: \033[0;0;0m ') 
print('\n')
...
print('\033[1;45m You will now enter the total number of counted live cells (CLC) in the sample. \033[0;0;0m ')
...
cells = float(input('\033[1;45m Enter the number of CLC: \033[0;0;0m '))
print('\n')
...
print(str(micro) + ' \u03BCl of CLC \033[0;0;0m ')
