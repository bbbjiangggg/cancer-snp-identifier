    ...
    for dir_name in os.listdir():
        if 'RR' in dir_name and os.path.isdir(dir_name):
            ...
            for file_name in os.listdir(dir_name):
                if file_name.endswith('_mapped.bam'):
                    ...
                    if b'SO:coordinate' not in header:
                        ...
                        # Sort the BAM file
                        sort_bam_path = output_dir / f"{file_name[:-4]}_mapped.sorted.bam"
                    ...
                    if output_count_file:
                            ...
                            cmd = f'htseq-count -f bam -s no -i gene_id {output_bam_path} {annotation_file} > {output_count_file}'
