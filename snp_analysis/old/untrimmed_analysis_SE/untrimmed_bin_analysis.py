...
while chromosome not in valid_chromosomes:
    chromosome = input(f'{MAGENTA}5){RESET} Enter the chromosome number (e.g., 1, 2, ... 22, X, Y) to be analyzed: ')
...
# Print the paths
print(f'{MAGENTA}6){RESET} Bowtie Index Path: {bowtie_index_path}')
print(f'{MAGENTA}7){RESET} BWA Chromosome Path: {bwa_chrom_path}')
