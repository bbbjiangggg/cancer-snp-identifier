...
def main():
    ...
    # QIIME 2 Analysis for 16S rRNA Sequencing
            print(colored("\nStarting QIIME 2 Analysis for 16S rRNA Sequencing...", "magenta"))
    # Importing the data into a QIIME 2 artifact
    run_command("qiime tools import --type 'SampleData[SequencesWithQuality]' \
                --input-path demux --input-format CasavaOneEightSingleLanePerSampleDirFmt \
                    --output-path demux.qza")
        # Running DADA2 for denoising
    run_command("qiime dada2 denoise-single \
    ...
    run_command("qiime feature-classifier classify-sklearn \
                    --i-classifier classifier.qza \
                    --i-reads rep-seqs-dada2.qza \
                    --o-classification taxonomy.qza")
        # Generating summary and visualization reports
    run_command("qiime taxa barplot \
                    --i-table table-dada2.qza \
                    --i-taxonomy taxonomy.qza \
                    --m-metadata-file sample-metadata.tsv \
                    --o-visualization taxa-bar-plots.qzv")
    print(colored("QIIME 2 Analysis Completed.", "magenta"))
